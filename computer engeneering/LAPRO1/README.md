...
Se o jogador optar pela opção **listar a pontuação** (`Figura 5`), o programa deve exibir um ranking
...
Em resumo, **o trabalho consiste em completar o código fornecido através da implementação
